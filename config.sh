...
export DT_LINK="https://github.com/rushiranpise/android_device_motorola_chef_twrp -b retrofit-test"
...
export KERNEL_SOURCE="https://github.com/PixelExperience-Devices/kernel_motorola_msm8998 -b twelve"
